...
function draw() {
  if(gameState === "START"){
    ...
    if(circle1.isTouching(inv1)||circle1.isTouching(inv2)||circle1.isTouching(inv3)||circle1.isTouching(inv4)){
      circle1.x = 500;
      circle1.y = 200;
    }
    if(circle3.isTouching(inv1)||circle3.isTouching(inv2)||circle3.isTouching(inv3)||circle3.isTouching(inv4)){
      circle3.x = 500;
      circle3.y = 750;
    }
    ...
    if(points2 === 50){
      ...
      textSize(15);
      fill("purple");
      text("WALUIGI WON THE GAME", 500, 600);
    }
    if(points1 === 50){
      gameState = "END";
      textSize(15);
      fill("yellow");
      text("WARIO WON THE GAME", 500, 600);
    }
    if(gameState === "END"){
      hidden();
      textSize(15);
